export function SupportRulesCard({
  rounds,
  initialPoints,
}: {
  rounds: number | null
  ...
  return (
    <div className="rounded-2xl border border-border bg-card p-5 shadow-sm">
      ...
      <ul className="flex flex-col gap-1.5 text-sm text-muted-foreground">
        <li>One show of support per match, and you can&apos;t back both players.</li>
        <li>Support locks the instant a match goes live — no edits after that.</li>
        <li>
        ...
        {initialPoints !== null && rounds !== null && (
          <li>
            ...
            <strong className="text-foreground">{initialPoints} points</strong> — enough to support
